...
?>
        ...
        <div class="grid_10">
            <div class="box round first">
                ...
                <?php
                    $id=$_GET["id"];
				$res2=mysqli_query($link,"select * from display_order where pid=$id");
            ...
            echo "<td style='font-weight:bold'>"; echo "contact no"; echo "</td>";
                ...
                echo "<td>"; echo $row1["city"]; echo "</td>";
                echo "<td>"; echo $row1["pincode"]; echo "</td>";
                ...
                $res=mysqli_query($link,"select * from display_order where pid=$id");
                echo "<table border='1'>";
                echo "<tr>";
