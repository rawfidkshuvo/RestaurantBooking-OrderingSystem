...
<div class="grid_10">
    <div class="box round first">
        ...
        <div class="block">
            ...
            <?php
            $res = mysqli_query($link, "select * from order_placement");
            echo "<table border='4'>";
            echo "<tr>";
            ...
            while($row=mysqli_fetch_array($res))
            {
                ...
                echo "<td>"; ?> <a href="display_order_1.php?id=<?php echo $row["placement_id"]; ?>">View Order</a> <?php echo "</td>";
				echo "<td>"; ?> <a href="confirmation.php?id=<?php echo $row["placement_id"]; ?>">Confirm</a> <?php echo "</td>";
                echo "</tr>";
            }
            echo "</table>";
